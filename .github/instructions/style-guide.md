...
@theme {
  ...
  --font-family-heading: "Anta", sans-serif;
...
>
  <!-- Logo -->
  <span class="font-heading shrink-0 text-lg tracking-[0.08em] text-accent">APPNAME</span>
...
<div class="relative z-1 flex min-h-screen items-center justify-center p-6">
  ...
  >
    ...
    <h1 class="font-heading mb-9 text-5xl leading-[1.1] text-text">Sign in.</h1>
